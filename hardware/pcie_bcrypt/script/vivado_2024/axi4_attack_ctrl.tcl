...
proc create_root_design { parentCell } {
  ...
  # Create instance: bcrypt_cracker_0, and set properties
  set block_name bcrypt_cracker
  set block_cell_name bcrypt_cracker_0
  if { [catch {set bcrypt_cracker_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bcrypt_cracker_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_mdm_axi [get_bd_intf_pins microblaze_0_axi_periph/M00_AXI] [get_bd_intf_pins mdm_1/S_AXI]
  ...
  connect_bd_net -net bcrypt_cracker_0_cracker_cycle [get_bd_pins bcrypt_cracker_0/cracker_cycle] [get_bd_pins cracker_regs_0/cracker_cycle]
  connect_bd_net -net bcrypt_cracker_0_done [get_bd_pins bcrypt_cracker_0/done] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net bcrypt_cracker_0_dout [get_bd_pins bcrypt_cracker_0/dout] [get_bd_pins axi_gpio_0/gpio2_io_i]
  connect_bd_net -net bcrypt_cracker_0_dout_we [get_bd_pins bcrypt_cracker_0/dout_we] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net bcrypt_cracker_0_pwd_regs_addra [get_bd_pins bcrypt_cracker_0/pwd_regs_addra] [get_bd_pins cracker_regs_0/cracker_addra]
  connect_bd_net -net bcrypt_cracker_0_pwd_regs_addrb [get_bd_pins bcrypt_cracker_0/pwd_regs_addrb] [get_bd_pins cracker_regs_0/cracker_addrb]
  connect_bd_net -net bcrypt_cracker_0_success [get_bd_pins bcrypt_cracker_0/success] [get_bd_pins xlconcat_0/In1]
  ...
  connect_bd_net -net cracker_regs_0_bram_addr_a [get_bd_pins cracker_regs_0/bram_addr_a] [get_bd_pins axi_bram_ctrl_0_bram/addra]
  connect_bd_net -net cracker_regs_0_bram_addr_b [get_bd_pins cracker_regs_0/bram_addr_b] [get_bd_pins axi_bram_ctrl_0_bram/addrb]
  connect_bd_net -net cracker_regs_0_bram_en_a [get_bd_pins cracker_regs_0/bram_en_a] [get_bd_pins axi_bram_ctrl_0_bram/ena]
  connect_bd_net -net cracker_regs_0_bram_en_b [get_bd_pins cracker_regs_0/bram_en_b] [get_bd_pins axi_bram_ctrl_0_bram/enb]
  connect_bd_net -net cracker_regs_0_bram_rst_a [get_bd_pins cracker_regs_0/bram_rst_a] [get_bd_pins axi_bram_ctrl_0_bram/rsta]
  connect_bd_net -net cracker_regs_0_bram_rst_b [get_bd_pins cracker_regs_0/bram_rst_b] [get_bd_pins axi_bram_ctrl_0_bram/rstb]
  connect_bd_net -net cracker_regs_0_bram_we_a [get_bd_pins cracker_regs_0/bram_we_a] [get_bd_pins axi_bram_ctrl_0_bram/wea]
  connect_bd_net -net cracker_regs_0_bram_we_b [get_bd_pins cracker_regs_0/bram_we_b] [get_bd_pins axi_bram_ctrl_0_bram/web]
  connect_bd_net -net cracker_regs_0_bram_wrdata_a [get_bd_pins cracker_regs_0/bram_wrdata_a] [get_bd_pins axi_bram_ctrl_0_bram/dina]
  connect_bd_net -net cracker_regs_0_bram_wrdata_b [get_bd_pins cracker_regs_0/bram_wrdata_b] [get_bd_pins axi_bram_ctrl_0_bram/dinb]
  connect_bd_net -net cracker_regs_0_cracker_douta [get_bd_pins cracker_regs_0/cracker_douta] [get_bd_pins bcrypt_cracker_0/pwd_regs_douta]
  connect_bd_net -net cracker_regs_0_cracker_doutb [get_bd_pins cracker_regs_0/cracker_doutb] [get_bd_pins bcrypt_cracker_0/pwd_regs_doutb]
  connect_bd_net -net cracker_regs_0_cracker_hash [get_bd_pins cracker_regs_0/cracker_hash] [get_bd_pins bcrypt_cracker_0/t_hash]
  connect_bd_net -net cracker_regs_0_cracker_salt [get_bd_pins cracker_regs_0/cracker_salt] [get_bd_pins bcrypt_cracker_0/t_salt]
  connect_bd_net -net cracker_regs_0_cracker_start [get_bd_pins cracker_regs_0/cracker_start] [get_bd_pins bcrypt_cracker_0/cracker_start]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins bcrypt_cracker_0/clk] [get_bd_pins cracker_regs_0/clk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins bcrypt_cracker_0/rst] [get_bd_pins cracker_regs_0/rst]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins axi_gpio_0/gpio_io_i]
